...
export async function initCommand(): Promise<void> {
  ...
  console.log(chalk.white("  Welcome! Let's get you set up in under 2 minutes.\n"))
  ...
  if (answers.network === "testnet") {
    console.log()
    console.log(chalk.cyan("  [2/4] Funding wallet via Friendbot (testnet)..."))
  ...
  fs.writeFileSync(configPath, JSON.stringify(globalConfig, null, 2), { mode: 0o600 })
  ...
  try {
    ...
    logger.warn("Could not verify Groq key (network issue) — continuing anyway")
  }
  ...
  console.log(chalk.cyan("    stellar-agent list"))
  console.log(chalk.cyan("    stellar-agent call <agent-name> \"your task\""))
  console.log()
}
